...
public class ElfStack {
     ...
     public static void main(String[] args) throws IOException {
          ...
          for (int[] row : instructions) {
               ...
               originalPushPop(quantity, stacks[stackFrom], stacks[stackTo]);
          }
     ...
     private static void originalPushPop(int quantity, Stack<Character> from, Stack<Character> to) {

          for (int i = 0; i < quantity; i++) {
               if (!from.isEmpty()) {
                    char popThis = from.pop();
                    to.push(popThis);
               } else {
